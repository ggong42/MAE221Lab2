function createfigure(volt2a1, temp2a1)
%CREATEFIGURE(volt2a1, temp2a1)
%  VOLT2A1:  vector of x data
%  TEMP2A1:  vector of y data

%  Auto-generated by MATLAB on 15-Oct-2019 10:18:47
...
% Create plot
plot1 = plot(volt2a1,temp2a1,'DisplayName','data1','Marker','o',...
    'LineStyle','none');
...
% Plot the fit
fitLine1 = plot(xplot1,yplot1,'DisplayName','   cubic','Tag','cubic',...
...
% Create title
title('Measured Temperature (°C) vs. Output Voltage (V) in Thermistor');
