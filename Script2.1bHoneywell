function createfigure(pres2b1, dV2b1)
%CREATEFIGURE(pres2b1, dV2b1)
%  PRES2B1:  vector of x data
%  DV2B1:  vector of y data

%  Auto-generated by MATLAB on 14-Oct-2019 23:39:42
...
% Create plot
plot1 = plot(pres2b1,dV2b1,'DisplayName','data1','Marker','o',...
    'LineStyle','none');
...
% Create title
title('Calculated Pressure (kPa) vs. Recorded Voltage Change (V) with Honeywell Sensor');
